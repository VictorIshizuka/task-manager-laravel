<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('success'))
                <div
                    class="mb-4 p-4 bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-700 text-green-700 dark:text-green-200 rounded-lg flex items-center">
                ...
                <div class="p-6">
                            ...
                            <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex flex-wrap gap-4 text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        <!-- Contador de Tasks (se tiver relacionamento) -->
                                ...
                                <div class="flex gap-2 items-start">
                                    <a href="{{ route('projects.show', $project) }}"
                                        class="inline-flex items-center px-3 py-2 bg-blue-600 dark:bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 dark:hover:bg-blue-600 transition">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                    ...
                    @empty
                        ...
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('projects.create') }}"
                                    class="inline-flex items-center px-4 py-2 bg-indigo-600 dark:bg-indigo-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 dark:hover:bg-indigo-600 transition">
